...
def list_var_name(list_of_tensors):
    """
    Inputs a list of Tensors and returns a list containing the name of each tensor.
    """
...
def get_var(list_of_tensors, prefix_name=None):
    """
    Input a Tensor list (optional variable name prefix), return two lists [variable name], [variable]
    """
